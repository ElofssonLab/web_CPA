...
\subsection{Topology}
The knotted topology was established using an implementation of Alexander polynomial described in the KnotProt database \cite{jamroz2014knotprot}. Several hundred random closures are chosen in a way that the endpoints are connected to two randomly 
...
KMT algorithm and the Alexander polynomial is computed.
